...
const runEvents = [
  ...
  },
  {
    ...
    title: "从人才平台召回候选人",
    summary:
      "已扫描 68 张候选人卡片；合并内部与公开来源后得到 46 位唯一候选人。",
    tone: "success",
    icon: "users",
    detail:
      "同一平台串行、不同平台并行；重复项已通过姓名、履历和来源标识批量合并。",
  },
  {
    time: "10:18:22",
    title: "读取候选人详情和附件",
    summary:
      "已打开 19 个候选人详情；18 位已完成解析和匹配，1 份附件正在视觉解析。",
    tone: "info",
    icon: "file",
    detail:
      "已完成 18 / 46；处理中 1；PDF 附件 2 份；失败 0；检查点：detail-page-2-item-6。",
  },
  {
    time: "10:24:09",
    title: "岗位角色门禁与匹配",
